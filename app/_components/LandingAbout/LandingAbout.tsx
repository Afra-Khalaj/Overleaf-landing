      ...
      >
        ...
        >
          ...
          <LandingAboutCard
            ...
            desc={
              "با قابلیت مشارکت هم‌زمان تا ۱۰ نفر در یک پروژه، دیگه نیازی به ارسال فایل و هماهنگ‌ کردن نسخه‌ها نداری. همه‌ چیز در لحظه سینک میشه."
            }
          />
          <LandingAboutCard
          ...
          <LandingAboutCard
            ...
            desc={
              "پشتیبانی کامل از نوشتار راست‌به‌چپ، فونت‌های فارسی، و قالب‌های آماده‌ی مورد نیاز برای نگارش پایان‌نامه، مقاله یا پروژه‌های دانشگاهی به زبان فارسی."
            }
          />
        </div>
      </div>
