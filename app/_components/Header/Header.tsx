...
const Header = () => {
  return (
    <div className='flex items-center px-6 pb-10'>
        ...
        <Link href="/templates" className='ms-auto text-xl hover:text-primary'>Templates</Link>
        <Link href="/docs" className='ms-6 me-6 text-xl hover:text-primary'>Docs</Link>
